  ...
  return (
    <div id='about' className='w-full h-screen p-2 flex items-center py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            ...
            <p className="uppercase text-sm tracking-widest text-[#5651e5]">About</p>
            ...
            <div className='w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center p-4 hover:scale-105 ease-in duration-300'>
              <img className='rounded-xl' src="https://w0.peakpx.com/wallpaper/831/303/HD-wallpaper-laptop-keys-gradient.jpg" alt="/" />
            </div>
        </div>
    </div>
  )
